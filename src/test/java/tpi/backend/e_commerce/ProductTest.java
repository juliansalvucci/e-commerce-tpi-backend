...
public class ProductTest {
    ...
    void testCreateProductWithInvalidData() throws Exception {
        ...
        CreateProductDTO productDto = new CreateProductDTO(
                "", // name vacío
                "Esta descripción es demasiado larga para ser aceptada por el DTO. Este texto excede los 100 caracteres permitidos por la anotación @Size.", // description
                                                                                                                                                             // inválida
                -5.0, // price negativo
                -1L, // stock negativo
        ...
        // Realizar la solicitud POST simulada
        mockMvc.perform(post("/tu-endpoint")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(productDto)))
